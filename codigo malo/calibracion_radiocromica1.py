...
class CalibrationCurvesCanvas(FigureCanvas):
    """Canvas para mostrar las curvas de calibración, cada canal en un subplot separado."""
    def __init__(self, parent=None, width=12, height=4, dpi=100):
        ...
        self.axes[0].set_ylabel('Dosis (Gy)')
        self.fig.tight_layout()
...
class InstructionsDialog(QWidget):
    ...
    def setup_ui(self):
        ...
        instructions = [
            ...
            ("", "   - Ingrese la dosis correspondiente en el campo 'Dosis (Gy)', IMPORTANTE USAR NOTACION DECIMAL CON PUNTO PARA TODOS LOS VALORES."),
